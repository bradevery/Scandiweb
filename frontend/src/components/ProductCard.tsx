  ...
  return (
    ...
    >
      ...
      <div className="p-2">
        {in_stock && (
          <div
            className="absolute bottom-14 sm:bottom-16 right-3 sm:right-4 bg-[#5ece7b] p-1.5 sm:p-2 rounded-full opacity-0 group-hover:opacity-100 transition cursor-pointer"
